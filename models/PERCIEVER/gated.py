...
from perceiver_pytorch.perceiver_pytorch import cache_fn, fourier_encode, PreNorm, FeedForward, Attention
...
class Perceiver(nn.Module):
    def __init__(
        ...
        get_cross_attn = lambda: GRUGating(latent_dim, PreNorm(latent_dim,
                                                               Attention(latent_dim, input_dim, heads=cross_heads,
                                                                         dim_head=cross_dim_head, dropout=attn_dropout),
                                                               context_dim=input_dim))
        get_latent_attn = lambda: GRUGating(latent_dim, PreNorm(latent_dim, Attention(latent_dim, heads=latent_heads,
