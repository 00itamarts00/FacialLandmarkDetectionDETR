...
def fft_resize(Z, sfactor):
    ...
    Zf = np.pad(Zf, ((padsz0, padsz0), (padsz1, padsz1)), mode='constant', constant_values=(0, 0))
...
def fft_resize_to(Z, dstsz):
    ...
    Zf = np.pad(Zf, ((padsz0s, padsz0e), (padsz1s, padsz1e)), mode='constant', constant_values=(0, 0))
