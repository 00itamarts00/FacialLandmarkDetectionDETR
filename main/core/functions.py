...
def train_epoch(train_loader, model, criteria, optimizer, scheduler, epoch, **kwargs):
    logger_cml = Logger.current_logger()
    max_norm = 0
...
def validate_epoch(val_loader, model, criteria, epoch, **kwargs):
    logger_cml = Logger.current_logger()
