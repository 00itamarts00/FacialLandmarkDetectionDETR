...
#
# This source src_code is licensed under the MIT license found in the
...
class RangerQH(Optimizer):
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                param_state["beta1_weight"] = 1.0 + \
                    beta1 * param_state["beta1_weight"]
                param_state["beta2_weight"] = 1.0 + \
                    beta2 * param_state["beta2_weight"]
    ...
    def _params_to_dict(cls, params):
        return {"lr": params.alpha, "nus": (
            params.nu1, params.nu2), "betas": (params.beta1, params.beta2)}
